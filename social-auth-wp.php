...
Plugin URI: https://github.com/mbarlock/socialauth-wp
Description: This plugin is a hold over until we can get all the code merged to use this plugin naturally instead of our own version
Version: 3.11.13
